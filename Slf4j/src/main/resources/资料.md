...
3. [logback使用](https://blog.csdn.net/smileKutper/article/details/109303276)
4. [logback使用](https://blog.csdn.net/weixin_45433031/article/details/122476569)
```text
logback是log4j改进，logback有如下有点：
...
```
6. [日志框架冲突解决方案](https://www.jianshu.com/p/cb43ac01b458)